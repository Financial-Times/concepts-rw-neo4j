...
func getConcept(t *testing.T, name string) ontology.SourceConcept {
	c := ontology.SourceConcept{}
...
func TestInvalidTypesThrowError(t *testing.T) {
	...
	for _, scenario := range scenarios {
		...
		assert.Contains(t, err.Error(), "unknow concept type 'Unknown'", "Scenario "+scenario.testName+" failed; should throw error from mapper.MostSpecificType function")
	}
...
func TestTransferConcordance(t *testing.T) {
	...
	for _, scenario := range scenarios {
		returnedQueryList, _, err := conceptsDriver.handleTransferConcordance(scenario.updatedSourceIds, "1234", ontology.NewAggregatedConcept{}, "")
...
func TestTransferCanonicalMultipleConcordance(t *testing.T) {
	...
	mergeManagedLocationCanonicalWithTwoSources := testStruct{
		...
		targetConcordance: ontology.AggregatedConcept{
			PrefUUID: "1",
			SourceRepresentations: []ontology.SourceConcept{
				ontology.SourceConcept{UUID: "1", Authority: "Smartlogic"},
				ontology.SourceConcept{UUID: "4", Authority: "FACTSET"},
				ontology.SourceConcept{UUID: "2", Authority: "ManagedLocation"},
			},
		},
	}
	mergeManagedLocationCanonicalWithTwoSourcesAndGeonames := testStruct{
		...
		targetConcordance: ontology.AggregatedConcept{
			...
			SourceRepresentations: []ontology.SourceConcept{
				...
				ontology.SourceConcept{UUID: "4", Authority: "FACTSET"},
				ontology.SourceConcept{UUID: "2", Authority: "ManagedLocation"},
				ontology.SourceConcept{UUID: "5", Authority: "TME"},
			},
		},
	}
