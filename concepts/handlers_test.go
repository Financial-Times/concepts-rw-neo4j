...
func TestPutHandler(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			mockService: &mockConceptService{
				decodeJSON: func(decoder *json.Decoder) (interface{}, string, error) {
					return transform.AggregatedConcept{PrefUUID: knownUUID, Type: "Dummy"}, knownUUID, nil
				},
		...
		},
		{
			...
			mockService: &mockConceptService{
				decodeJSON: func(decoder *json.Decoder) (interface{}, string, error) {
					return transform.AggregatedConcept{PrefUUID: knownUUID, Type: "FinancialInstrument"}, knownUUID, nil
				},
				write: func(thing interface{}, transID string) (interface{}, error) {
					return ConceptChanges{}, nil
				},
		...
		},
		{
			...
			mockService: &mockConceptService{
				decodeJSON: func(decoder *json.Decoder) (interface{}, string, error) {
					return transform.AggregatedConcept{PrefUUID: knownUUID, Type: "not-dummy"}, knownUUID, nil
				},
				write: func(thing interface{}, transID string) (interface{}, error) {
					return ConceptChanges{}, nil
				},
...
func TestGetHandler(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			ds: &mockConceptService{
				read: func(uuid string, transID string) (interface{}, bool, error) {
					return transform.AggregatedConcept{PrefUUID: knownUUID, Type: "Dummy"}, true, nil
				},
			},
			statusCode:  http.StatusOK,
			contentType: "",
		...
		},
		{
			...
			ds: &mockConceptService{
				read: func(uuid string, transID string) (interface{}, bool, error) {
					return transform.AggregatedConcept{PrefUUID: knownUUID, Type: "Location"}, true, nil
				},
			},
			statusCode:  http.StatusOK,
			contentType: "",
		...
		},
		{
			...
			ds: &mockConceptService{
				read: func(uuid string, transID string) (interface{}, bool, error) {
					return transform.AggregatedConcept{PrefUUID: knownUUID, Type: "not-dummy"}, true, nil
				},
			},
			statusCode:  http.StatusBadRequest,
			contentType: "",
