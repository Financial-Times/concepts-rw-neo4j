...
func TransformToNewSourceConcept(c ontology.SourceConcept) ontology.NewSourceConcept {
...
func TransformToOldSourceConcept(c ontology.NewSourceConcept) ontology.SourceConcept {
...
func TransformToNewAggregateConcept(c ontology.AggregatedConcept) ontology.NewAggregatedConcept {
...
func TransformToOldAggregateConcept(c ontology.NewAggregatedConcept) ontology.AggregatedConcept {
	...
	concept := ontology.AggregatedConcept{
		PrefUUID:               c.PrefUUID,
		PrefLabel:              prefLabel,
		Type:                   c.Type,
		Aliases:                aliases,
